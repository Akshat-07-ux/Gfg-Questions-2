<h2><a href="https://www.geeksforgeeks.org/problems/hungry-pizza-lovers3148/1?page=5&category=Greedy&sortBy=submissions">Hungry Pizza Lovers</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Dominos Pizza has&nbsp;hungry customers waiting in the queue. Each unique order&nbsp;is placed by a customer at time&nbsp;x[i], and the order takes&nbsp;y[i]&nbsp;units of time to complete.<br>
