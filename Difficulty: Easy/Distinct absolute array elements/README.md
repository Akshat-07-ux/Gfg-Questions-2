<h2><a href="https://www.geeksforgeeks.org/problems/distinct-absolute-array-elements4529/1?page=7&category=Sorting&sortBy=submissions">Distinct absolute array elements</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 18px;">Given a sorted array <strong>arr[]</strong>. Count the number of distinct absolute values present in the array.</span></p>
