<h2><a href="https://www.geeksforgeeks.org/problems/largest-permutation1351/1?page=6&category=Greedy&sortBy=submissions">Largest Permutation</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 14pt;">Given a permutation&nbsp;as an array and an integer k. Print the lexicographically largest permutation after at most k swaps.</span></p>
