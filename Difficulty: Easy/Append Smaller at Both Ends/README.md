<h2><a href="https://www.geeksforgeeks.org/problems/repeat-the-strings/1?page=7&category=Strings&sortBy=submissions">Append Smaller at Both Ends</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><div class="qMYqUG_convSearchResultHighlightRoot">
