<h2><a href="https://www.geeksforgeeks.org/problems/difficulty-of-sentence5856/1?page=6&category=Strings,Linked%20List,Divide%20and%20Conquer&company=Microsoft&sortBy=submissions">Difficulty of sentence</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a sentence as a string <strong>S</strong>. Calculate difficulty of a given sentence. </span></p>
