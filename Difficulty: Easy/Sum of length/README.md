<h2><a href="https://www.geeksforgeeks.org/problems/sum-of-length3345/1?page=8&category=Hash&sortBy=submissions">Sum of length</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given an array <strong>arr</strong>. Calculate the sum of lengths of contiguous subarrays having all distinct elements.<br>Note: Return the answer with modulo 10<sup>9</sup></span><span style="font-size: 18px;">+7.</span></p>
