<h2><a href="https://www.geeksforgeeks.org/problems/chinese-postman/1?page=6&category=Graph&sortBy=submissions">Chinese Postman</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given a graph find the shortest cyclic path or circuity that visits every edge of the graph at least once.</span></p>
...
<p><span style="font-size: 18px;"><strong>Expected Time Complexity:</strong>&nbsp;O(sqrt(N!))<br><strong>Expected Auxiliary Space:</strong> O(N*N)</span>&nbsp;</p>
