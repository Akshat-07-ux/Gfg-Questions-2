...
<p><span style="font-size: 18px;"><strong>Constraints:</strong><br>1 &lt;= N &lt;= 10<sup>2</sup><br>0&lt;= edges[i][0],edges[i][1] 1&lt;=edges[i][2]&lt;=10<sup>4</sup><br>0&lt;=src,dst,k src!=dst</span></p></div><br><p><span style=font-size:18px><strong>Topic Tags : </strong><br><code>Graph</code>&nbsp;