<h2><a href="https://www.geeksforgeeks.org/problems/string-formation-from-substring2734/1?page=9&category=Strings&sortBy=submissions">String formation from substring</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given a string s, the task is to check if it can be constructed by taking a substring of it and appending multiple copies of the substring together.&nbsp; </span></p>
